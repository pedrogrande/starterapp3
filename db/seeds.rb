...
p2 = Product.create(name: 'Chromecast Ultra', description: "Stream entertainment to your 4K Ultra HD TV in striking detail. No 4K TV? No problem. Chromecast Ultra automatically optimizes for the maximum your TV can deliver.", price: 99.0, num_in_stock: 800)
puts "Product created: " + p2.name

p3 = Product.create(name: 'Pixel 2 XL', description: "The unlocked Pixel 2 provides a clean, bloat-free experience with no unwanted apps, one of the highest rated smartphone cameras, with free unlimited storage.", price: 999.0, num_in_stock: 100)
